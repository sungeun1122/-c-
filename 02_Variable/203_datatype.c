...
*	C언어의 데이터 타입
*
*	 char : 1byte, 문자하나(정수)  8 bit   => 256
*	 short : 2byte  정수          16 bit  => 65536
*	 int  : 4byte   정수          32 bit  => 42억?
*	 long : 4byte   정수 (시스템마다 다름) 32 bit
*	 float : 4byte  실수          32 bit
*	 double : 8byte 실수          64 bit
*
*/
...
int main()
{
	...
	// 문자타입 변수
	char ch1;  // 1byte (8bit), 256개 표현 가능한 용량
...

	{
		...
		signed char ch1 = 200;  // char ch1 과 동일,  signed 일반적으로 생략
